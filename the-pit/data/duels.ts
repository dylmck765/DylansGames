...
export const duelPool: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: [
      "The obligation to sell shares at any price",
      "The right to buy 100 shares at the strike",
  ...
  },
  {
    ...
    options: [
      ...
      "Yesterday's closing price for the stock",
      "The preset price where the option lets you buy or sell the shares",
      "The price where trading gets halted"
    ],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ["It rises", "It falls", "It stays exactly the same", "It instantly goes to zero"],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: [
      "Adding value as expiration nears",
      "Draining value — time decay never takes a day off",
      "Only kicking in on Fridays",
      "Increasing the delta"
    ],
    correctIndex: 1,
    explanation: "Theta is the play clock. Every day that passes, a long option bleeds a little time value, whether the stock moves or not."
  },
  {
    id: "duel-10",
    question: "What does implied volatility (IV) actually measure?",
    options: [
      "How much the stock moved last year",
      "The option's guaranteed return",
      "How many contracts traded today",
      "The size of the move the market is pricing in going forward"
    ],
    correctIndex: 3,
  ...
  },
  {
    ...
    options: [
      "Unlimited",
      "The premium you paid — that is the whole bill",
  ...
  },
  {
    ...
    options: [
      "Implied volatility collapses after an event, deflating option premium fast",
      "The stock crashing after earnings",
      "Your broker raising margin requirements",
      "Volume drying up at the close"
    ],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: [
      ...
      "It accelerates — decay gets faster near the end",
      "It flips positive for buyers"
    ],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: [
      "IV crush — the vol premium deflated more than delta gained",
      "The market maker stole your fill",
      "Earnings beats always sink calls",
      "Theta only hits on earnings day"
    ],
    correctIndex: 0,
    explanation: "You were right on direction and still lost — classic. The 2% pop was not enough to outrun the volatility premium collapsing after the event."
  },
  {
    id: "duel-23",
  ...
  },
  {
    ...
    options: [
      "B — the wider spread means more upside",
      "Either one, spreads do not matter",
      "A — the tight spread means you are not bleeding edge on entry and exit",
  ...
  },
  {
    ...
    options: [
      "You pay more premium, but theta bleeds slower and your thesis gets time to work",
      "You pay less premium and decay slower",
      "You pay more and decay faster",
  ...
  },
  {
    ...
    options: [
      "Straddle buyers — any move pays",
      "Nobody",
      "Only the shareholders",
      "Premium sellers — the move came in under the $4 the market priced"
    ],
    correctIndex: 3,
  ...
  },
  {
    ...
    options: [
      ...
      "Cut your cost, but capped your max gain at the $110 strike",
      "Doubled your delta",
      "Removed all time decay"
    ],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: [
      "Average down — it is cheaper now",
      "Hold to expiration, anything can happen",
      "Cut it — the thesis is broken, save the rest of the premium",
  ...
  },
  {
    ...
    options: [
      "The at-the-money call expiring this week — it is almost all event premium",
      "A deep in-the-money call — mostly intrinsic value",
      "The stock shares themselves",
      "A two-year LEAPS that barely prices the event"
    ],
    correctIndex: 0,
